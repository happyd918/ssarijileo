...
function Mypage() {
  ...
  const changeMicVolume = (e: React.ChangeEvent<HTMLInputElement>) => {
    DUMMY_DATA.micVolume = Number(e.target.value);
  };

  const changeEcho = (e: React.ChangeEvent<HTMLInputElement>) => {
    DUMMY_DATA.echo = Number(e.target.value);
  };
