...
VALUE ("USER111111111", "sm@ssafy.com", "이수민", "token1", "A"),
	("USER222222222", "th@gmail.com", "김태학", "token2", "A"),
      ("USER333333333", "mj@naver.com", "김명준", "token3", "A"),
      ("USER444444444", "sw@kakao.com", "길상욱", "token4", "A"),
      ("USER555555555", "sy@ssafy.com", "김소윤", "token5", "A"),
      ("USER666666666", "yj@ssafy.com", "서예지", "token6", "A"),
      ("USER777777777", "ksf@ssafy.com", "김싸피", "token7", "B"),
      ("USER888888888", "psf@ssafy.com", "박싸피", "token8", "X");
...
VALUE ("USER111111111", "USER333333333", "A"),
	("USER111111111", "USER444444444", "A"),
      ("USER222222222", "USER111111111", "W"),
      ("USER555555555", "USER666666666", "A"),
      ("USER333333333", "USER222222222", "A"),
      ("USER333333333", "USER666666666", "X");
...
VALUE ("USER111111111", 1, "N", 50, "00:04:43", "2023-01-01 09:00:00"),
	("USER222222222", 2, "P", 70, "00:02:22", "2023-01-01 14:24:00"),
      ("USER333333333", 3, "O", 100, "00:02:40", "2023-01-06 12:30:00"),
      ("USER111111111", 6, "N", 90, "00:02:30", "2023-01-12 09:20:00"),
      ("USER444444444", 4, "R", 90, "00:02:30", "2023-01-12 18:30:00"),
      ("USER555555555", 5, "R", 30, "00:01:24", "2023-01-12 18:30:25"),
      ("USER666666666", 6, "N", 80, "00:03:30", "2023-01-25 15:20:00"),
      ("USER111111111", 1, "N", 70, "00:04:40", "2023-01-25 10:00:00");

-- 애창곡 데이터

INSERT INTO `fovorite_song` (`user_id`, `song_id`, `is_like`)
VALUE ("USER111111111", 1, "Y"),
	("USER111111111", 6, "Y"),
      ("USER222222222", 2, "Y"),
      ("USER111111111", 2, "Y"),
      ("USER111111111", 2, "N"),
...
VALUE ("USER111111111", 1, "file1", "2023-01-01 09:05:00"),
	("USER222222222", 2, "file2", "2023-01-01 14:29:00"),
      ("USER333333333", 3, "file3", "2023-01-06 12:35:00"),
      ("USER444444444", 4, "file4", "2023-01-12 18:35:00"),
      ("USER555555555", 5, "file5", "2023-01-12 18:35:25"),
      ("USER666666666", 6, "file6", "2023-01-25 15:25:00");
